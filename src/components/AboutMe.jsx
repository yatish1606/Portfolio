...
class AboutMe extends React.Component {
    ...
    componentDidMount() {
            ...
            this.setState({strokeDashoffset: length})
            ...
            function fillOnScroll() {
                ...
                // parentReference.setState({strokeDashoffset: length - draw})
            }
     }
    ...
    render() {
        return (
            <div style={{backgroundColor:'black', height:1000, color:'white'}} className="parentDiv" ref={this.parentReference}>
                <div className="svgDiv">
                    ...
                    <svg height={410} width={400}>
                        ...
                        transform="translate(-6.49 -4.36)" fill="none" stroke="green" strokeDashoffset={this.state.strokeDashoffset} />
                    </svg>
                </div>
            </div>
        )
